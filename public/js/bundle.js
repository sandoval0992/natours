...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = "pk.eyJ1Ijoic2FuZG92YWwwOTkyIiwiYSI6ImNrOGNlZWR5bTA1Ymkza3FleGxzZHQ0b28ifQ.CfYl4qvohZluolXh4WtAig";
  var map = new mapboxgl.Map({
    container: "map",
    style: "mapbox://styles/sandoval0992/cky4o88r40bh614klxbtzywvm",
    scrollZoom: false
  });
  var bounds = new mapboxgl.LngLatBounds(); //Draws a marker on each location
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Marker({
      element: marker,
      anchor: "bottom"
    }).setLngLat(location.coordinates).addTo(map); //Displays a pop up window with tour description
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(data);
            _context.prev = 2;
            endPoint = type === "password" ? "update-password" : "update-info";
            _context.next = 6;
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://localhost:8001/api/v1/users/".concat(endPoint),
              data: data
            });
          ...
          case 6:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "".concat(type, " upated successfully"));
            }
...
// Public key
var stripe = Stripe("pk_test_51KKXegKrssDgJvLzUqwangHYXWHcvnDnYrjGt0YjUgE3CZyK8DLKp16UwD48VRQBHQjPVWxTahW4NRIMkoQQQMAS00x2qOpHMp");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            console.log(tourId);
            _context.next = 4;
            return (0, _axios.default)("http://localhost:8001/api/v1/bookings/checkout-session/".concat(tourId));
...
console.log("Loading index.js"); // DOM elements
...
var bookBtn = document.getElementById("book-tour"); //Task delegation
...
if (userDataForm) {
  console.log("Submit event update data");
...
if (userPasswordForm) {
  ...
  function () {
    ...
    regeneratorRuntime.mark(function _callee(event) {
      var currentPasswordTxt, newPasswordTxt, passwordConfirmTxt, currentPassword, newPassword, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              currentPasswordTxt = document.getElementById("password-current");
              newPasswordTxt = document.getElementById("password");
              passwordConfirmTxt = document.getElementById("password-confirm");
              currentPassword = currentPasswordTxt.value;
              newPassword = newPasswordTxt.value;
              passwordConfirm = passwordConfirmTxt.value;
              _context.next = 10;
